...
const UserProfile = () => {
  ...
  useEffect(() => {
    // Khud ki profile → /profile/me pe redirect
    if (id === me?._id) {
    ...
    Promise.all([getUser(id), getUserPosts(id)])
      .then(([userRes, postsRes]) => {
        ...
        // backend { user, posts } return karta hai getUser mein
    ...
    <div className="min-h-screen bg-background">
      ...
      <PageTransition>
        <div className="mx-auto max-w-2xl px-4 py-6 space-y-6">
          ...
          >
            <div
              className="mx-auto flex h-20 w-20 items-center justify-center rounded-full text-2xl font-bold text-primary-foreground mb-4"
              style={{ background: getColor(profile.name) }}
            >
            ...
            <motion.button
              ...
              disabled={sent}
              className={`mt-5 inline-flex items-center gap-2 rounded-lg px-6 py-2.5 text-sm font-medium transition ${
                sent
